        ...
        <div className='h-container'>
          ...
          >
            ...
            <g id='Layer_2' data-name='Layer 2'>
              <g id='Layer_1-2' data-name='Layer 1'>
                <text
                  className='cls-11'
                  transform='translate(1.39 136.55) rotate(-0.6)'
                >
                  PuRe
                </text>
                <text className='cls-22' transform='translate(2.53 195.24)'>
                  Dashboard
                </text>
              </g>
            </g>
          ...
          <div className='v-container'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 651.82 317.54'>
              ...
              <g id='Layer_2' data-name='Layer 2'>
                <g id='Layer_1-2' data-name='Layer 1'>
                  <text className='cls-1' transform='translate(7.14 247.8)'>
                    follow the repo
                  </text>
                </g>
              </g>
